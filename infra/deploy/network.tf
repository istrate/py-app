...
# Create security group to assign to endpoints and allow us to connect to those endpoints
# We will have a resource group that we can assign to resources created into the subnet to
# so they can connect to those the endpoints
